...
def main_function():
    ...
    if x>=0 and x<=2:
        ...
        def sol5():
            sol5=("Since, it is given that the weights of "+n1+", "+n2+", "+n3+" and "+n4+"\nare "+latex(str(r1))+", "+latex(str(r2))+", "+latex(str(r3))+" and "+latex(str(r4))+" respectively")+"\n"
            if r1*r2==r3*r4:
                a=r1*r2
                b=r3*r4
                sol5=sol5+("Now, "+latex(str(r1)+" * "+str(r2)+" = "+str(a)))+"\n"
                ...
                a=r1*r3
                b=r2*r4
                sol5=sol5+("Now, "+latex(str(r1)+" * "+str(r3)+" = "+str(a)))+"\n"
                ...
                a=r1*r4
                b=r2*r3
                sol5=sol5+("Now, "+latex(str(r1)+" * "+str(r4)+" = "+str(a)))+"\n"
        ...
        def sol6():
            sol6=("Since, it is given that the weights of "+n1+", "+n2+", "+n3+" and "+n4+"\nare "+latex(str(r1))+", "+latex(str(r2))+", "+latex(str(r3))+" and "+latex(str(r4))+" respectively")+"\n"
            if r1*r2==r3*r4:
                a=r1*r2
                b=r3*r4
                sol6=sol6+("Now, "+latex(str(r1)+" * "+str(r2)+" = "+str(a)))+"\n"
                ...
                a=r1*r3
                b=r2*r4
                sol6=sol6+("Now, "+latex(str(r1)+" * "+str(r3)+" = "+str(a)))+"\n"
                ...
                a=r1*r4
                b=r2*r3
                sol6=sol6+("Now, "+latex(str(r1)+" * "+str(r4)+" = "+str(a)))+"\n"
